...
protected:
	...
	//------ Blur Pass Program
	glmlv::GLProgram programBlurPassOnX;
	glmlv::GLProgram programBlurPassOnY;
	...
	GLuint uTextureSizeXPass;
	GLuint uTextureSizeYPass;
	...
	*/
	...
	//-- POST PROCESS DIRECTIONAL BLUR PASS
	void postProcessBlurPassOnX(GLuint tex);
	void postProcessBlurPassOnY(GLuint tex);
